        ...
        <div class="content">
          <template v-if="true">
            ...
            >
              ...
              <div class="right" v-if="v.data && v.data.title">
                <div class="title">
                  <i>{{ v.data.title }}</i>
              ...
              <div
                ...
                element-loading-background="#f7f7fa"
              ></div>
            </div>
          </template>
        </div>
...
export default {
  ...
  created () {
    ...
    if (
      initAllData &&
      initAllData.aries.data &&
      initAllData.capricorn.data &&
      initAllData.leo.data
    ) {
  ...
  methods: {
    setNewListData () {
      ...
      console.log(this.NewListData, 'set')
    },
    itemClick (v) {
